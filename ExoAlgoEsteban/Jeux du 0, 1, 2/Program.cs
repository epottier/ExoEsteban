    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while ((parties_gagnées_par_joueur != 10 )|| (parties_gagnées_par_ordinateur != 10) || (nombre_propose_par_Joueur < 0))
            {
                ...
                if (nombre_propose_par_Joueur < -1)
                {
                    Console.WriteLine("Le Joueur à quitter la partie");
                }
                else if ((nombre_propose_par_Joueur >= 0) || (nombre_propose_par_Joueur <= 2))
                {
                ...
                {
                    Console.WriteLine("Le Joueur doit choisir un nouveau nombre");
